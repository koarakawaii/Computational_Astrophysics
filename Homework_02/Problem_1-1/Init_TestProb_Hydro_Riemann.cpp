...
// (1-2) set the default values
   switch ( Riemann_Prob )
   {
      case SOD_SHOCK_TUBE : Riemann_RhoL = 0.2;    Riemann_VelL = 50.0;  Riemann_PreL = 10.0;  Riemann_VelL_T1 = 0.0;  Riemann_VelL_T2 = 0.0;
                            Riemann_RhoR = 0.125;  Riemann_VelR = -25;  Riemann_PreR = 1.0;  Riemann_VelR_T1 = 0.0;  Riemann_VelR_T2 = 0.0;
                            Riemann_EndT = 0.4;
#                           ifdef MHD
